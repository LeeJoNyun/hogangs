    ...
    return (
        <section id="grooming_photo_section" ref={scopeRef}>
            <div className="inner">
                ...
                <img src="/grooming/photo/1.webp" alt="" className="img1" ref={img1Ref} />
                <img src="/grooming/photo/2.webp" alt="" className="img2" ref={img2Ref} />
                <img src="/grooming/photo/3.webp" alt="" className="img3" ref={img3Ref} />
                <img src="/grooming/photo/4.webp" alt="" className="img4" ref={img4Ref} />
            </div>
