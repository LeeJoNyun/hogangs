...
export default function BubbleLanding({ onClose }) {
    ...
    useEffect(() => {
        ...
        ul.innerHTML = '';
        const originals = [
            { normal: '/main/ganady.webp', variant: '/main/ganady01.webp' },
            { normal: '/main/ganady.webp', variant: '/main/ganady01.webp' },
        ];
        originals.forEach(() => {
            ...
            li.innerHTML = `
        <div class="dog">
          <img src="/main/ganady.webp" alt="dog" />
          <img class="variant" src="/main/ganady01.webp" alt="dog-variant" />
        </div>`;
            ul.appendChild(li);
        });
        ...
        <>
            ...
            <div ref={overlayRef} className={`landing-overlay ${popped ? 'pop' : ''}`}>
                ...
                <div className="mung-content">
                    <ul ref={ulRef}>
                        {['/main/ganady.webp', '/main/ganady01.webp'].map((_, idx) => (
                            <li key={idx}>
                                <div className="dog">
                                    <img src="/main/ganady.webp" alt="" />
                                    <img className="variant" src="/main/ganady01.webp" alt="" />
                                </div>
                            </li>
                        ))}
                    </ul>
                ...
                <div ref={shapeFrameRef} className="landing-shape">
                    ...
                    <ul ref={shapeTrackRef} className="shape-track">
                        ...
                        {/* 트랙: 이동 */}
                        <li>
                            <img className="bone" src="/main/Bone-shape.webp" alt="" />
                        </li>
                        <li>
                            <img className="bone" src="/main/Bone-shape.webp" alt="" />
                        </li>
